...
func PrepareS3(t *testing.T, bucket string, serializer s3_v1_model.SerializerConfig) *s3_v1_model.S3Destination {
	...
	cfg := &s3_v1_model.S3Destination{
		...
		RotatorConfig:       s3_v1_model.RotatorUnion{Default: &s3_v1_model.DefaultRotatorConfig{Interval: time.Hour, MaxRecordsCount: 0, IsRegularRotationEnabled: false}},
		...
		TimeExtractorType:   s3_v1_model.RecordMetaTimeExtractor,
		TimeExtractorConfig: s3_v1_model.TimeExtractorUnion{RecordMeta: &s3_v1_model.RecordMetaTimeExtractorConfig{}, DataField: nil},
