...
func (d *DockerWrapper) Pull(ctx context.Context, image string, opts docker_image.PullOptions) error {
...
func (d *DockerWrapper) RunContainer(ctx context.Context, opts DockerOpts) (stdout io.Reader, stderr io.Reader, err error) {
	...
	if err := d.Pull(ctx, opts.Image, docker_image.PullOptions{}); err != nil {
		return nil, nil, err
	}
