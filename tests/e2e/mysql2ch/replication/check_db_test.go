...
func TestReplication(t *testing.T) {
	...
	require.NoError(t, storage.WaitEqualRowsCount(t, Source.Database, "mysql_replication", storagecomparison.GetSampleableStorageByModel(t, Source), storagecomparison.GetSampleableStorageByModel(t, Target), 60*time.Second))
