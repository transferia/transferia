...
`))
	...
	require.NoError(t, storage.WaitDestinationEqualRowsCount("public", "__test", storagecomparison.GetSampleableStorageByModel(t, Target.LegacyModel()), 60*time.Second, expectedYtRows))
	worker.Close(t)
