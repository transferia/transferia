...
func load(t *testing.T, transfer *model.Transfer, updateSource bool) {
	...
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited", 10)
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited_y2006m02", 3)
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited_y2006m03", 4)
	storagecomparison.CheckRowsCount(t, transfer.Src, "public", "measurement_inherited_y2006m04", 3)

	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative", 12)
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m02", 3)
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m03", 4)
	storagecomparison.CheckRowsCount(t, transfer.Src, "public", "measurement_declarative_y2006m04", 3)
	storagecomparison.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m05", 2)
	...
	require.NoError(t, storage.WaitEqualRowsCount(t, "postgres", "measurement_inherited_y2006m02", sourceStorage, targetStorage, 60*time.Second))
	require.NoError(t, storage.WaitEqualRowsCount(t, "postgres", "measurement_inherited_y2006m03", sourceStorage, targetStorage, 60*time.Second))
	...
	require.NoError(t, storage.WaitEqualRowsCount(t, "postgres", "measurement_declarative_y2006m02", sourceStorage, targetStorage, 60*time.Second))
	require.NoError(t, storage.WaitEqualRowsCount(t, "postgres", "measurement_declarative_y2006m03", sourceStorage, targetStorage, 60*time.Second))
	...
	storagecomparison.CheckRowsCount(t, transfer.Dst, "postgres", "measurement_inherited", 10)
	storagecomparison.CheckRowsCount(t, transfer.Dst, "postgres", "measurement_declarative", 12)
